        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-slate-500 text-xs">{sekolah.nama || 'SIMBK'} · Ruang Bimbingan Digital</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-pink-700 rounded-3xl p-6 text-white shadow-xl">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-purple-200 text-sm mt-1">{portalUser.kelas || 'Siswa SIMBK'}</p>
            </div>
          </div>
