  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className={`relative w-full ${sizes[size]} bg-dark-950 border border-white/10 rounded-2xl shadow-2xl animate-in flex flex-col max-h-[90vh]`} style={{ animationDuration: '0.25s' }}>
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-white/10 flex-shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-full hover:bg-white/10 text-dark-400 hover:text-white transition-colors ml-4 flex-shrink-0"
          >
        ...
        {/* Footer */}
        {footer && (
          <div className="p-5 border-t border-white/10 bg-dark-900/50 flex-shrink-0">
            {footer}
          </div>
        )}
      </div>
